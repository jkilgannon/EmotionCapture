...
model = Sequential()
model.add(Conv2D(base_size, (9, 9), activation='relu', input_shape=(48, 48, 1)))

model.add(MaxPooling2D(pool_size=(2, 2)))

model.add(Conv2D(base_size*4, (5, 5), activation='relu'))

model.add(MaxPooling2D(pool_size=(2, 2)))

model.add(Dropout(0.1))

model.add(Conv2D(base_size*8, (3, 3), activation='relu'))
